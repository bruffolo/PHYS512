# N body simulation - Particle Mesh Method      <img src= ./photo.png width="400"> <img src= ./Orbit_complex.png width="350">
...
NOTE: If you want all the data, set both ```save_iter``` and ```save_nth``` to 1.
